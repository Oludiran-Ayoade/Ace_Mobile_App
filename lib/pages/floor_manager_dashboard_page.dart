...
class FloorManagerDashboardPage extends StatefulWidget {
  const FloorManagerDashboardPage({super.key});

  @override
  State<FloorManagerDashboardPage> createState() => _FloorManagerDashboardPageState();
}

class _FloorManagerDashboardPageState extends State<FloorManagerDashboardPage> {
  ...
  Future<void> _verifyAccessAndLoadData() async {
    try {
      ...
      // Verify user is a Floor Manager, Operations Manager, or Supervisor
      final roleName = userData['role_name'] as String?;
      final roleCategory = userData['role_category'] as String?;
      
      bool isAuthorized = (roleName != null && (
        roleName.contains('Floor Manager') ||
      ...
      if (!isAuthorized) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Unauthorized access. You must be a Floor Manager, Operations Manager, or Supervisor.'),
